...
void Menu::start() const {
    ...
    do {
        ...
        switch (option) {
            ...
            std::cout << "Presione ENTER continuar..."; //system("pause");
            std::cin.ignore(1000, '\n');
        }
    } while (option != 0);
}
